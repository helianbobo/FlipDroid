 ...
 * any methods. Use {@link CustomConcurrentHashMap.Builder} to create a custom concurrent hash map
 * instance. Client libraries implement {@link CustomConcurrentHashMap.Strategy}, and this class
 ...
 * {@link CustomConcurrentHashMap.Builder#buildComputingMap(CustomConcurrentHashMap.ComputingStrategy, common.base.Function)}
 * ).
 * <p>
...
final class CustomConcurrentHashMap {
    ...
    public interface Strategy<K, V, E> {
         ...
         * that was provided to {@link CustomConcurrentHashMap.Strategy#newEntry} when the given entry
         * was created.
         * 
         * @return the next entry or null if null was passed to
         *         {@link CustomConcurrentHashMap.Strategy#newEntry}
         */
        E getNext(E entry);

        /**
         * Returns the hash code that was passed to {@link CustomConcurrentHashMap.Strategy#newEntry})
    ...
    /**
     * Extends {@link CustomConcurrentHashMap.Strategy} to add support for computing values on-demand.
     ...
     * 
     * @see CustomConcurrentHashMap.Builder#buildComputingMap(CustomConcurrentHashMap.ComputingStrategy,
     *      Function)
     */
    public interface ComputingStrategy<K, V, E> extends Strategy<K, V, E> {
         ...
         *        that was created
         * @param computer
         *        passed to {@link CustomConcurrentHashMap.Builder#buildMap}
     ...
     * {@link CustomConcurrentHashMap.SimpleInternalEntry}. Intended to be subclassed to provide
    ...
    /**
     * A basic, no-frills entry class used by {@link CustomConcurrentHashMap.SimpleInternalEntry}.
     */
