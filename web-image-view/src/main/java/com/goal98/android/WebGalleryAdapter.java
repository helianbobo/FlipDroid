...
/**
 * Can be used as an adapter for an Android {@link android.widget.Gallery} view. This adapter loads the images to
...
public class WebGalleryAdapter extends BaseAdapter {
     ...
     *            the resource ID of the drawable that will be used if a read error occurs
     */
    public WebGalleryAdapter(Context context, List<String> imageUrls, int progressDrawableResId,
                             int errorDrawableId) {
