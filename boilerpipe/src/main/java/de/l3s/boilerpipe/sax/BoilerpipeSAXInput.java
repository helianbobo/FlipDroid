...
public final class BoilerpipeSAXInput implements BoilerpipeInput {
    ...
    public TextDocument getTextDocument(boolean forChinese) throws BoilerpipeProcessingException {
        return getTextDocument(new BoilerpipeHTMLParser(forChinese?new BoilerpipeHTMLChineseContentHandler():new BoilerpipeHTMLContentHandler()));
    }
