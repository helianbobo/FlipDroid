...
public final class BlockProximityFusion implements BoilerpipeFilter {
    ...
    public boolean process(TextDocument doc)
        ...
        for (Iterator<TextBlock> it = textBlocks.listIterator(offset); it
            ...
            if (!block.isContent() || block.hasLabel(DefaultLabels.INDICATES_SKIP_OF_TEXT)) {
                prevBlock = block;
                continue;
            }
            ...
            if (diffBlocks <= maxBlocksDistance) {
                ...
                boolean hasTerminatingLink = prevBlock.getLinkDensity() != 0 && prevBlock.hasLabel(DefaultLabels.INDICATES_SKIP_OF_TEXT);
