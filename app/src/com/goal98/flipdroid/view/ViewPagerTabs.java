...
public class ViewPagerTabs extends ViewGroup implements OnPageChangeListener {
	...
	private int mTextColor = Constants.PAGER_SIDE_TEXT_COLOR;        //side color
	private int mTextColorCenter = Constants.PAGER_CENTER_TEXT_COLOR;  //center color
	
	private int mLineColor = 0x00000000;
	private int mLineColorCenter = Constants.PAGER_UNDERLINE_COLOR;  //underline color
