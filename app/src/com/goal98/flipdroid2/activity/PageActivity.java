...
import com.goal98.flipdroid2.anim.AnimationFactory;
...
import com.goal98.flipdroid2.model.*;
...
import com.goal98.flipdroid2.model.google.GoogleReaderArticleSource;
import com.goal98.flipdroid2.model.rss.RemoteRSSArticleSource;
import com.goal98.flipdroid2.model.sina.SinaArticleSource;
import com.goal98.flipdroid2.model.sina.SinaToken;
import com.goal98.flipdroid2.model.taobao.TaobaoArticleSource;
import com.goal98.flipdroid2.multiscreen.MultiScreenSupport;
import com.goal98.flipdroid2.util.*;
import com.goal98.flipdroid2.view.*;
...
public class PageActivity extends Activity implements com.goal98.flipdroid2.model.Window.OnLoadListener, SourceUpdateable {
...
//    private Page currentSmartPage;
    ...
    public com.goal98.flipdroid2.model.Window preparingWindow;
...
//                        nextBottom.setVisibility(View.VISIBLE);
    ...
    public void onWindowLoaded(com.goal98.flipdroid2.model.Window window) {
        if (forward)
            next = window.get();
        else
            previous = window.get();
    ...
    public void onWindowSkipped(com.goal98.flipdroid2.model.Window pageViewWindow) {
        handler.post(new Runnable() {
...
//                }
            ...
            final com.goal98.flipdroid2.model.Window nextWindow = preparingWindow;
            preparingWindow = null;
