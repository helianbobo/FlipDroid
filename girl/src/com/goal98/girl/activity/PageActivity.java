...
import com.goal98.girl.anim.AnimationFactory;
import com.goal98.girl.client.OAuth;
import com.goal98.girl.db.RSSURLDB;
import com.goal98.girl.db.SourceContentDB;
...
import com.goal98.girl.model.google.GoogleReaderArticleSource;
import com.goal98.girl.model.rss.RemoteRSSArticleSource;
import com.goal98.girl.model.sina.SinaArticleSource;
import com.goal98.girl.model.sina.SinaToken;
import com.goal98.girl.model.taobao.TaobaoArticleSource;
import com.goal98.girl.multiscreen.MultiScreenSupport;
import com.goal98.girl.util.*;
import com.goal98.girl.view.*;
...
public class PageActivity extends Activity implements com.goal98.girl.model.Window.OnLoadListener, SourceUpdateable {
...
//    private Page currentSmartPage;
    ...
    public com.goal98.girl.model.Window preparingWindow;
...
//                        nextBottom.setVisibility(View.VISIBLE);
    ...
    public void onWindowLoaded(com.goal98.girl.model.Window window) {
        if (forward)
            next = window.get();
        else
            previous = window.get();
    ...
    public void onWindowSkipped(com.goal98.girl.model.Window pageViewWindow) {
        handler.post(new Runnable() {
...
//                }
            ...
            final com.goal98.girl.model.Window nextWindow = preparingWindow;
            preparingWindow = null;
